const Footer = () => {
    return (
        <footer className="mt-3">
            <div className="footer p-10 bg-[#8b393f] text-neutral-content">
                <div>
                    ...
                    <p>
                        <strong>Lingua Camp</strong>
                        <br />
                        <small>Providing language learning since 2023</small>
                    </p>
                </div>
                <div>
                    <span className="footer-title">Contact</span>
                    <p>Phone: 123-456-7890</p>
                    <p>Email: info@linguacamp.com</p>
                </div>
                <div>
            ...
            <div className="footer footer-center p-4 bg-base-300 text-base-content">
                <div>
                    <p>Copyright © 2023 - All rights reserved by Lingua Camp</p>
                </div>
            </div>
        </footer>
    );
